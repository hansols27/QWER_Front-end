...
// ⭐️ 이미지 크기 상수를 정의합니다. (백엔드 리사이징 크기인 400px x 400px로 통일)
const IMAGE_WIDTH = 400; // ⭐️ 수정됨: 384 -> 400
const IMAGE_HEIGHT = 400; // ⭐️ 수정됨: 288 -> 400
            ...
            <Box p={4}>
                ...
                <Box
                    sx={{
                        ...
                        // 좌측 정렬 및 최소 너비 400px(이미지 너비)로 자동 맞춤
                        gridTemplateColumns: `repeat(auto-fill, ${IMAGE_WIDTH}px)`, // ⭐️ 400px로 업데이트
                            ...
                            <Box key={album.id}>
                                <Card
                                    ...
                                    sx={{
                                        ...
                                        width: `${IMAGE_WIDTH}px`, // ⭐️ 400px로 업데이트
                                    }}
                                >
                                    {/* 이미지 컨테이너 크기를 400x400로 고정 */}
                                    <Box
                                        sx={{
                                            position: 'relative',
                                            width: `${IMAGE_WIDTH}px`, // ⭐️ 400px로 업데이트
                                            height: `${IMAGE_HEIGHT}px`, // ⭐️ 400px로 업데이트
                                        }}
                                    >
                                        <Image
                                            src={imageUrl}
                                            ...
                                            style={{
                                                // objectFit: 'cover'는 이미 적용되어 있어 그대로 유지합니다.
                                                objectFit: 'cover', 
                                                position: 'absolute',
                                                top: 0,
                                                left: 0,
